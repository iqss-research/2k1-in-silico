...
helptext <- reactive(data.table(
  ...
  intro = c("This is tutorial mode, a guided walk-through of 2k1 In Silico. If you are already familiar with the app, you can use the exit button above.",
            ...
            "If you selected a DGP with no intermediate parameters, you can skip this step! This plot shows you the distribution of your intermediate parameter, based on your covariates and your parameter choices. This represents the systematic part of the data generation process.",
