...
helptext <- reactive(data.table(
  ...
  intro = c("This is tutorial mode, a guided walk-through of 2k1 In Silico. If you are already familiar with the app, you can use the exit button above.",
            ...
            "Skip this step if your DGP does not have covariates. If your DGP allows you to select covariates, you can do so here. These are variables that help to generate your outcome data. You can use the + button to add covariates, and the - button to remove covariates. Click on X1, X2, etc. to see the underlying distribution of the covariate.",
            ...
            "If you selected a non-ordinal DGP, you can skip this step! If you selected an ordinal DGP, this is a plot which shows you the distribution of the unobserved variable.",
            "If you selected a DGP with no covariates, you can skip this step! This plot shows you the distribution of your intermediate parameter, based on your covariates and your parameter choices. This represents the systematic part of the data generation process.",
            "If you selected a DGP without covariates or intermediate parameters, you can skip this step! This plot shows you how your covariate relates to the intermediate parameter. If you have more than one covariate, use the dropdown below the X Axis to select which covariate's relationship you would like to see.",
            ...
            "If your assumed distribution does not have covariates, you can skip this step! Now you can select covariates that you want to be used in the model. Again, you know which covariates you used in the DGP tab, but you can replicate the real-world by choosing different ones, too. You can use the plus or minus buttons to add or remove covariates.",
            ...
            "If your assumed distribution does not have covariates or intermediate parameters, you can skip this step! This plot shows you how your assumed covariate relates to your intermediate parameter, according to the assumed distribution and assumed beta parameters. If you selected more than one covariate, you can change the covariate below the x axis.",
            ...
            "If your assumed distribution does not have covariates, you can skip this step! Now you can select the values for the assumed covariates, allowing you to predict outcome values for this specific case.",
            ...
            "If your assumed distribution does not have covariates, you can skip this step! Here is the functional form plot which shows how your chosen covariate relates to the intermediate parameter. Notice how there is shading for the uncertainty in our estimates."
