...
% \newcommand{\graycirclei}{%
%   \begin{tikzpicture}[baseline=(char.base)]
%     \node[shape=circle,fill=lightgray,font=\sffamily] (char) {\textcolor{white}{i}};
%   \end{tikzpicture}%
% }

\newcommand{\graycirclei}{%
  \begin{tikzpicture}[baseline=(char.base)]
    \node[shape=circle, fill=lightgray, font=\tiny, inner sep=1pt, minimum size=1em] (char) {\textcolor{white}{i}};
  \end{tikzpicture}%
}
